...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     PRINT = 258,
     PRINT_WITH_NEW_LINE = 259,
     REGEX = 260,
     PARAMETER_DELIMETER = 261,
     STRING = 262
   };
#endif
...
{
       0,     0,     3,     4,     6,     7,    11,    16,    21,    23
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      12,     0,    -1,    -1,    13,    -1,    -1,    14,     8,    13,
      -1,     3,     9,    15,    10,    -1,     4,     9,    15,    10,
      -1,     7,    -1,     5,     9,     7,     6,     7,    10,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    38,    38,    39,    42,    43,    46,    50,    56,    60
};
#endif
...
{
  "$end", "error", "$undefined", "PRINT", "PRINT_WITH_NEW_LINE", "REGEX",
  "PARAMETER_DELIMETER", "STRING", "';'", "'('", "')'", "$accept", "prog",
  "statements", "statement", "string_expression", 0
};
#endif
...
{
      10,     6,    11,     1,     2,     7,     8,     9,    16,    19,
      15,    18,    17,     0,    20,    21,    13,    14
};

static const yytype_int8 yycheck[] =
{
       5,     9,     7,     3,     4,     9,     0,     8,    10,     6,
       9,     7,    10,    -1,     7,    10,     7,     9
};
...
{
       0,     3,     4,    12,    13,    14,     9,     9,     0,     8,
       5,     7,    15,    15,    13,     9,    10,    10,     7,     6,
       7,    10
};
...
#line 61 "parser.y"
    {
        regexCompile(&regex, (yyvsp[(3) - (6)].string));
        ...
        matcher = regexMatch(&regex, (yyvsp[(5) - (6)].string));
        (yyval.string) = (matcher.isFound) ? "true" : "false";
        free((yyvsp[(3) - (6)].string));
        free((yyvsp[(5) - (6)].string));
    ;}
    break;
